...
set nocount on
go
if object_id('dbo.helpActionsUpdate') is not null
begin
    drop procedure dbo.helpActionsUpdate
end
go
create procedure dbo.helpActionsUpdate
    @SystemID varchar(12)
...
begin
    ...
    begin
        select  @OldHelpText = a.HelpText
               ,@AudID = a.AuditID
        from    dbo.helpActions a (holdlock)
    ...
    begin
        ...
        execute dbo.helpActionsGet    -- return the changes
            @pSystemID = @SystemID
        ...
        if @AudID = -1
        begin
            print 'This Action has changed since it was retrieved'
        end
    end
    return @e
end
